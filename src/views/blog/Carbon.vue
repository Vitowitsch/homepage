  ...
  <v-container>
    ...
    <v-row>
      ...
      Blockchain itself can use up a lot of energy and create a huge amount of CO₂ emissions.
        ...
        The commission for world-wide trade could bring up to two billion a year.
   ...
   <v-col cols="12" sm="6">
        ...
        <v-row>
          <v-col cols="12" sm="4">
          <v-img :src="require('@/assets/pics/carbon_.jpeg')" />
          </v-col>
           <v-col cols="12" sm="4">
          <v-img :src="require('@/assets/pics/blockchain.jpg')" />
          </v-col>
           <v-col cols="12" sm="4">
