  ...
  <v-layout>
    <v-flex xs12 md6>
      <v-img :src="require('@/assets/pics/globe.jpg')" aspect-ratio="2.0" contain/>
      <v-img :src="require('@/assets/pics/carbon_.jpeg')" aspect-ratio="2.0" contain/>
      <base-heading>Forget Bitcoin - Blockchain can help reduce CO₂-emissions</base-heading>
    ...
    <v-flex xs12 md6>
      <base-text class="mb-5">
        ...
        Theoretically this idea could generate a lot of money. The commission for world-wide trade could bring up to two billion a year. This is a huge number and - we have to admit - too large a project for us to realise. We see a better trading system as a viable way to reduce CO₂ emission. By sharing the concept with different people in politics and within Siemens we hope to initiate changes - big or small.
        Team Carbon: Elena Scepankova, Veit Wehner, Johannes Oberreuter
      </base-text>
    </v-flex>
  </v-layout>
</template>
