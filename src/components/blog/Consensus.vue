  ...
  <article v-if="allReady" class="post">
    ...
    <section class="post__body rte">
      <blockquote class="post__subtitle">
        <center>
          <div class="title">Blockchain got famous through Bitcoin and infamous through the energy-wasting mining farms. Meanwhile novel Blockchain projects were introduced proposing new solutions. </div>
        </center>
      </blockquote>
      <p></p>
...
<p></p>
But DLT is not undisputed. Others criticize it as an unnecessary technology which wastes huge amounts of energy. They say that blockchain applications could also be implemented with conventional technologies like centralized databases or multi-signature-wallets.
<p></p>
...
<p></p>
A mechanism that keeps participants from adding invalid transactions is called a Consensus Strategy. There are many different such strategies, Proof-of-Work (POW) and Proof-of-Stake (POS) being the most important. They both have one thing in common: Fraud hurts. Adding invalid transactions has a price.
<p></p>
Proof-of-Work first appeared in 2008 with the work of an unknown person or group going by the name of Satoshi Nakamoto. To add a transaction in a POW system, the machine must solve a complicated mathematical puzzle. This so-called mining costs a lot of computing power, money and energy. 
<p></p>
...
<p></p>
The deposit in a POS-system doesn’t need to be money, but it can be anything of value, such as the participant’s reputation. Imagine Walter White’s online shop in the Dark Web. To promote it he buys 1000 positive reviews. When this is discovered, the credibility of Walter suffers as does the credibility of everyone who gave a false review, as they brought in their credibility rate as non-monetary stake. A review from a customer who is known to give accurate ratings will count far more than those of someone caught in fraudulent activities. 
<p></p>
