  ...
  <article>
    <v-container fluid>
      ...
      <center>
        <div class="display-1">A smart city toll system (Cito) made second prizes</div>
      </center>
      <v-layout justify-space-around wrap mt-5>
        ...
        <v-flex xs12 md5>
          <base-text>
            I was part of a team of seven. The idea for the final project only emerged the night before the hackathon: We built a smart system that calculates dynamic price for entering - or parking - in the city, based on the real time NOx level. It should also include a 24h hours forecast. There were two options for billing: Either an IOT device on the car that would automatically deduct the payment from a prepaid account when it entered a city zone, or smart parking ticket vending machines.
            Our hackathon IoT-prototype retrieves real time and forecast pollution data from our cloud service. The city toll is deducted from a prepaid account, based on GPS and NOx level. Users can see their account balance, a 24 hour pollution forecast with corresponding prices on their mobile phones.
          </base-text>
        </v-flex>
        <v-flex xs11 mt-5>
          <base-text>
            We hope that this is a first step towards fewer cars and better air in cities. Cito can enforce legal pollution thresholds and bans on diesel cars - without tracking any personal GPS data.
...
export default {
  ...
  methods: {
    getVideoId() {
      return getIdFromURL("https://youtu.be/rVUP4-I9TJ4");
    }
  }
};
</script>
