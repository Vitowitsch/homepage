<template>
  <center>
    ...
    <v-layout justify-space-between class="text-xs-left" ml-5 mr-5 wrap>
      <v-flex xs12 md6>
        <div style="color:teal;margin-top:35px">:~$ git config --list</div>
        ...
        <br />
        <br />At the moment I am working for Siemens in Europe, where I got excellent recommendations.
        <br />In addition, I am looking for interesting side projects. About some of them you can read in my
        <router-link to="/blog" class="routerlink">blog</router-link>.
        <br />
      </v-flex>
